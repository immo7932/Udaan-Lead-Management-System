...
const RestaurantDetail = () => {
    ...
    if (!restaurant) {
        return (
            <div className="flex justify-center items-center h-screen bg-red-50">
                <div className="text-xl font-semibold text-red-600">No restaurant found.</div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-white p-6">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    <h2 className="text-3xl font-bold text-red-800 mb-4">{restaurant.name}</h2>
                    ...
                    <div className="flex space-x-4 mb-8">
                        <Link 
                            ...
                            className="bg-red-600 text-white px-6 py-2 rounded-md font-medium hover:bg-red-700 transition-colors duration-200"
                        >
                            Edit
                        </Link>
                        <button 
                            onClick={handleDelete}
                            className="bg-white text-red-600 px-6 py-2 rounded-md font-medium border-2 border-red-600 hover:bg-red-50 transition-colors duration-200"
                        >
                            Delete
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <section>
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-2xl font-semibold text-red-700">Contacts</h3>
                                <Link 
                                    to={`/restaurants/${restaurant._id}/contacts/new`}
                                    className="bg-red-600 text-white px-4 py-2 rounded-md font-medium hover:bg-red-700 transition-colors duration-200"
                                >
                                    Add Contact
                                </Link>
                            </div>
                        ...
                        <section>
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-2xl font-semibold text-red-700">Interactions</h3>
                                <Link 
